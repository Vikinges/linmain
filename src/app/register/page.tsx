        ...
        <Card className="glass-card border-white/20">
          ...
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleEmailSignUp} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-gray-300">{t.auth.nameLabel}</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-gray-300">{t.auth.confirmPasswordLabel}</Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                  <Input
                    id="confirmPassword"
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-gray-400">
              {t.auth.haveAccount}{" "}
              <Link href="/login" className="text-gray-200 hover:text-white underline">
                {t.auth.signInLink}
              </Link>
            </p>
          </CardFooter>
