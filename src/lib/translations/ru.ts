...
export const ru: Translations = {
  ...
  portfolio: {
    ...
    crmIot: {
      ...
      description:
        "<p>B2B платформа для отелей, домов отдыха и апартаментов, которые хотят <strong>монетизировать недвижимость эффективнее</strong> через IoT-инфраструктуру.</p><ul><li>Автоматический чекин/чекаут через умные замки</li><li>Сканер отпечатка пальца + клавиатура + NFC + беспроводные ключи</li><li>Режим Online (синхронизация с CRM) + Offline (предзагруженные коды)</li><li>Защищено нашей приватной европейской IoT-инфраструктурой</li></ul><p>Уже сейчас можно подать заявку и заказать электронный замок — мы свяжемся с вами лично.</p>",
    ...
    cloud: {
      title: "Приватное облако — ваши данные здесь",
      description:
        "<p>Облачные сервисы для тех, кому мы доверяем — и кто доверяет нам. Данные хранятся на нашем защищённом сервере <strong>в Баварии, Германия</strong>, который охлаждается настоящим альпийским воздухом 🏔️ — а не где-то в американском датацентре. Мы никогда не анализируем ваши данные и не продаём ваши предпочтения. Всё локально, всё ваше.</p><p><strong>📷 Immich</strong> — самохостинговая альтернатива Google Фото. ИИ-поиск, распознавание лиц, альбомы, шаринг — но ваши фото не покидают наш сервер. Доступ: <a href='https://photo.linart.club'>photo.linart.club</a></p><p><strong>☁️ Nextcloud</strong> — личное облако: файлы, календарь, контакты, документы. Как Dropbox или Google Drive — но приватный, в Европе, под вашим контролем. Доступ: <a href='https://cloud.crm-iot.com'>cloud.crm-iot.com</a></p><p>Доступ по приглашению для доверенных пользователей. Напишите нам, если хотите присоединиться.</p>",
    },
    placeholders: {
