...
export const ru: Translations = {
  ...
  portfolio: {
    ...
    hostLinart: {
      ...
      description:
        "<p>Наша приватная многопользовательская IoT-платформа для управления устройствами. Данные хранятся на сервере, <strong>которому можно доверять</strong> — а не в чьём-то чужом облаке. Сервер расположен локально в Баварии и охлаждается настоящим альпийским ветерком 🏔️</p><h3>Тарифы</h3><ul><li>🎁 <strong>Покупатели hardware</strong> — 1 год доступа к серверу БЕСПЛАТНО</li><li>⚡ <strong>Geeks</strong> — от 1.99€/мес (до 30 устройств)</li><li>🏢 <strong>B2B Cloud</strong> — от 49€/мес</li><li>🏆 <strong>Enterprise</strong> — Custom</li></ul><p><strong>🎉 Добро пожаловать, первые покупатели!</strong> Те, кто купил наше железо, получают бесплатный годовой доступ к серверу — и право гордиться. Как первые покупатели Apple, вы были здесь с самого начала. Участвуйте в мозговых штурмах, предлагайте идеи — возможно, именно вашу идею мы реализуем следующей, специально для вас!</p>",
